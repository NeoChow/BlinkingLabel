...
Pod::Spec.new do |s|
  ...
  s.version          = "0.1.0"
  s.summary          = "blinking blinking label"
...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  s.description      = "blinking blinking label blinking blinking label"
  s.homepage         = "https://github.com/nice-chow/BlinkingLabel"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "neo_chow" => "602040511@qq.com" }
